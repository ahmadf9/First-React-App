...
const SearchColumn = () => {
  ...
  return (
    <>
      <DarkBackground />
      <div id="search" className="container position-relative" style={{ zIndex: 2 }}>
        <div
          id="searchColumn"
        ...
        >
          <div className="row">
            <div id="driver-type" className="col-lg-2 col-sm-6 col-12">
              ...
              <select className="form-select form-select-md mb-3" aria-label=".form-select-lg example" value={driver} onChange={driverHandler}>
            ...
            <div id="date-input" className="col-lg-2 col-sm-6 col-12">
              ...
              <input id="inputDate" className="form-control" type="date" value={date} onChange={dateHandler} />
            </div>
            <div id="time-input" className="col-lg-3 col-sm-6 col-12  form-group has-feedback">
              <label htmlFor="inputTime">Waktu Jemput/ Ambil</label>
              <input step={1} id="inputTime" className="form-control" type="time" placeholder="Pilih Waktu" value={time} onChange={timeHandler} />
            </div>
      ...
      <ListCar>
        ...
        {date.length != 0 && time.length != 0 && cars && <CardCar cars={cars} />}
      </ListCar>
    </>
  );
};
